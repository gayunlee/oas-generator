...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        ContentTypeDto: "none" | "pick" | "series" | "secret" | "live" | "poll" | "all";
        MyPickV2Dto: {
            /**
             * @description Pick Id
             * @default <string>
         ...
         * @enum {string}
         */
        FinanceTypeDto: "none" | "domesticIndex" | "overseasIndex" | "domesticCommodityIndex" | "overseasCommodityIndex" | "exchangeRate" | "domesticStock" | "overseasStock";
        FinanceCardModel: {
            /**
         ...
         * @enum {string}
         */
        MembershipIntroductionType: "masterNotice" | "externalWebLink" | "InternalContent";
         ...
         * @enum {string}
         */
        USER_ROLE: "USER" | "ADMIN" | "MASTER" | "MONITOR" | "MASTER_ADMIN" | "MASTER_MONITOR";
        UserPaymentInfos: {
            /** @default <string> */
            masterCmsId: string;
            /** @default <integer> */
        ...
        Master: {
            ...
            membershipIntroduction?: components["schemas"]["MembershipIntroduction"] | null;
            /** @default <integer> */
         ...
         * @enum {string}
         */
        UserLevelTypeDto: "beginner" | "explorer" | "investor" | "analyst" | "finple";
        /**
         * @default <string>
         * @enum {string}
         */
        InterestType: "secondaryBattery" | "realty" | "investment" | "domesticStock" | "economicTheory" | "foreignStock" | "cryptoCurrency" | "companyAnalysis" | "macroEconomics" | "personalFinance" | "safeAsset" | "none";
        MePageState: {
            /**
             * @default <string>
             * @example 행복한 투자자
         ...
         * @enum {string}
         */
        TransactionStatus: "purchased_success" | "purchased_fail" | "subscription_cancelled" | "subscription_cancel_withdraw" | "subscription_changed";
        /**
         * @description 결제 수단 제공자
         * @default <string>
         * @enum {string}
         */
        MyMembershipPaymentProviderDto: "google" | "apple" | "hecto" | "us-campus" | "us-insight";
        /**
         * @description 결제수단형식
         * @default <string>
         * @enum {string}
        ...
        MyMembershipDetailScreenState: {
            ...
            transcations: (components["schemas"]["PurchaseSuccessCardModel"] | components["schemas"]["PurchaseFailCardModel"] | components["schemas"]["SubscriptionCancelCardModel"] | components["schemas"]["SubscriptionChangeCardModel"] | components["schemas"]["SubscriptionCancelWithdrawCardModel"])[];
        };
        /**
         * @description 결제수단
         * @default <string>
         ...
         * @enum {string}
         */
        PermissionStatusTypeDto: "unknown" | "denied" | "permanentlyDenied" | "granted" | "restricted" | "limited" | "provisional";
        PostDeviceBodyV3Dto: {
        ...
        ContentsResponse: {
            contents: (components["schemas"]["PickMetadataContent"] | components["schemas"]["SecretMetadataContent"])[];
        };
        MasterContentsResponseV2: {
            contents: (components["schemas"]["PickMetadataContent"] | components["schemas"]["SecretMetadataContent"] | components["schemas"]["SeriesMetadataContent"])[];
        ...
        SecretDetailMetadataContent: {
             ...
             */
            lineHeight: number;
            membershipIntroduction?: components["schemas"]["MembershipIntroductionDto"] | null;
            /** @default <string> */
         ...
         * @enum {string}
         */
        STATE_ENUM: "unknown" | "purchased_success" | "purchased_fail" | "purchased_refund" | "subscription_expired" | "subscription_cancelled" | "subscription_cancel_withdraw" | "subscription_changed" | "subscription_renewed" | "waiting_for_deposit" | "paymentmethod_change";
        MyProductMetadata: {
            /** @default <string> */
            myProductId: string;
         ...
         * @enum {string}
         */
        UserRoleName: "USER" | "ADMIN" | "MASTER" | "MONITOR" | "MASTER_ADMIN" | "MASTER_MONITOR";
         ...
         * @enum {string}
         */
        MarketingAgreeTypeDto: "isMarketingAgreed" | "isNightMarketingAgreed" | "all";
    ...
    naverAuthWithNative: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": {
                        data?: components["schemas"]["LoginSuccessDto"] | components["schemas"]["LoginNoJoinDto"];
                    };
                };
            };
        };
